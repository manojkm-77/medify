...
// SVG Icons mimicking lucide-react
...
const BedIcon = (props: React.SVGProps<SVGSVGElement>) => (
 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M2 4v16"/><path d="M2 10h20"/><path d="M6 4v16"/><path d="M18 4v16"/><path d="M22 10v10"/><path d="M12 4v16"/></svg>
);
...
export const ICONS = {
    HomeIcon, WalletIcon, CameraIcon, BedIcon, PillIcon, UserIcon, FileTextIcon, ClipboardIcon, UsersIcon, MicIcon, EditIcon, Trash2Icon
}

export const NAV_ITEMS: NavItem[] = [
  { id: 'Dashboard', labelKey: 'nav.home', icon: HomeIcon, showInNav: true },
  { id: 'Budget Planner', labelKey: 'nav.planner', icon: WalletIcon, showInNav: true },
  { id: 'Symptom Tracker', labelKey: 'nav.tracker', icon: CameraIcon, showInNav: true },
  { id: 'Bed Finder', labelKey: 'nav.beds', icon: BedIcon, showInNav: true },
  { id: 'Medicine Checker', labelKey: 'nav.meds', icon: PillIcon, showInNav: true },
  { id: 'Medical Records', labelKey: 'nav.records', icon: FileTextIcon, showInNav: false },
  { id: 'Appointments', labelKey: 'nav.appointments', icon: HomeIcon, showInNav: false },
  { id: 'Insurance Validator', labelKey: 'nav.insurance', icon: HomeIcon, showInNav: false },
  { id: 'Follow-up Center', labelKey: 'nav.followUps', icon: HomeIcon, showInNav: false },
  { id: 'Profile', labelKey: 'nav.profile', icon: UserIcon, showInNav: false },
];

export const DOCTOR_NAV_ITEMS: NavItem[] = [
  { id: 'Doctor Dashboard', labelKey: 'nav.doctorDashboard', icon: HomeIcon, showInNav: true },
  { id: 'AI Prescription', labelKey: 'nav.prescribe', icon: ClipboardIcon, showInNav: true },
  { id: 'Follow-ups', labelKey: 'nav.followUps', icon: UsersIcon, showInNav: true },
  { id: 'Profile', labelKey: 'nav.profile', icon: UserIcon, showInNav: true },
];