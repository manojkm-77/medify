...
// FIX: Made the `children` prop optional to allow the Dialog to be used without content, resolving a type error.
const Dialog = ({ open, onOpenChange, children }: { open: boolean, onOpenChange: (open: boolean) => void, children?: React.ReactNode }) => {
  ...
  return (
    ...
    >
      <div 
        className="relative bg-white rounded-lg shadow-xl max-w-lg w-full m-4"
